        ...
        if data is not None and len(data) == 7:
            ...
            if self.progressBar.value() == 100:
                ...
                self.db440Label.setText(
                    "440nm: " + str("{:.1f}".format(float(db440))) + "dB"
                )
                self.db435Label.setText(
                    "435nm: " + str("{:.1f}".format(float(db435))) + "dB"
                )
                self.db465Label.setText(
                    "465nm: " + str("{:.1f}".format(float(db465))) + "dB"
                )
                self.db546Label.setText(
                    "546nm: " + str("{:.1f}".format(float(db546))) + "dB"
                )
                self.db590Label.setText(
                    "590nm: " + str("{:.1f}".format(float(db590))) + "dB"
                )
                self.db600Label.setText(
                    "600nm: " + str("{:.1f}".format(float(db600))) + "dB"
                )
                self.db635Label.setText(
                    "635nm: " + str("{:.1f}".format(float(db635))) + "dB"
                )
                self.maxDBLabel.setText("Max u.a.: " + str("{:.1f}".format(float(maxDBvalue))) + "u.a.")
                self.maxNMLabel.setText("Max nm: " + str(maxNMvalue) + "nm")
                self.minDBLabel.setText("Min u.a.: " + str("{:.1f}".format(float(minDBvalue))) + "u.a.")
