...
9. Promediado con cuantos sweeps (Cuantas veces se grafica y se promedia entre esas medidas) ()
10. Diseñar para pantalla de 10 pulgadas (DONE)
11. Agregar datos estadísticos en el PDF (DONE)
12. Cambiar los parámetros fotometricos y agregar los radiometricos (DONE)
13. Ajuste del espectro a una línea recta ()
14. Agregar un tabs (parameters, about, etc) para ver los datos como en el PDF (DONE)
15. Detectar picos y valles en la gráfica ()
16. Invertir la curva (DONE)
17. Suavizar la curva (DONE)
18. Ajustar a diferentes tipos de gráficas [Gausiana, Lorentziana, 1er-4to orden] ()
19. Poder hacer baseline mas de una vez (DONE)
20. Añadir ventilador que extraiga aire de dentro del equipo (DONE, SE TIENE UNA ABERTURA EN EL DISEÑO)
